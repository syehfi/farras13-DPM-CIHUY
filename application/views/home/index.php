        ...
        <div id="carousel" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="active item">
                    ...
                    <img class="" src="<?= base_url() ?>img/slide1.jpg" alt=""></div>
                
                <div class="item">
                    <div class="caption zoomIn wow animated"> 		 			 
                        <h2>Komisi 2<br/><strong>SDM dan Organisasi</strong></h2>
                    </div>
                    <img class="" src="<?= base_url() ?>img/slide2.jpg" alt=""></div>
                
                <div class="item">
                    <div class="caption zoomIn wow animated"> 		 			
                        <h2>Komisi 3<br/><strong>Aspirasi dan Pengawasan</strong></h2>
                    </div><img class="" src="<?= base_url() ?>img/slide3.jpg" alt=""></div>
                
                <div class="item">
                    <div class="caption zoomIn wow animated"> 		 			
                        <h2>Komisi 4<br/><strong>Kerjasama dan Hubungan Luar</strong></h2>
                    </div><img class="" src="<?= base_url() ?>img/komisi4.jpg" alt=""></div>
            </div>
                    ...
                    <div class="row">
                        <div class="col-lg-4 wow fadeInLeft">	
                            <div class="contact_info">
                                ...
                                <div class="detail">
                                    <h4>Daftar DPM</h4>
                                    <p><a link href="http://bit.ly/formulirDPM19" target="_blank">http://bit.ly/formulirDPM19</a></p>
                                </div> 
                            </div>
