                  ...
                  <div class="x_content">
                        <form class="" action="" method="post" novalidate>
                            <div class="field item form-group">
                              <label class="col-form-label col-md-3 col-sm-3  label-align">Nama Acara<span
                            ...
                            <div class="field item form-group">
                              <label class="col-form-label col-md-3 col-sm-3  label-align">Komisi<span
                                  class="required">*</span></label>
                              <div class="col-md-6 col-sm-6">
                                <select id="komisi" class="form-control" required>
                            ...
                            <div class="field item form-group">
                              <label class="col-form-label col-md-3 col-sm-3  label-align">Konten<span
                                  class="required">*</span></label>
                              <div class="col-md-6 col-sm-6">
                            ...
                            <div class="field item form-group">
                              <label class="col-form-label col-md-3 col-sm-3  label-align">Upload Gambar<span
                                  class="required">*</span></label>
                              <div class="col-md-6 col-sm-6">
                                  <input type="file" data-role="magic-overlay" data-target="" data-edit="insertImage" />                              </div>
                            </div>
